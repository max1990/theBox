...
from .models import MARARawData, NormalizedDetection
...
class MARAParser:
    ...
    def autodetect_and_parse(self, line: str) -> NormalizedDetection | None:
        """
    ...
    def _parse_json(self, line: str) -> NormalizedDetection | None:
    ...
    def _parse_key_value(self, line: str) -> NormalizedDetection | None:
    ...
    def _parse_csv(self, line: str) -> NormalizedDetection | None:
        ...
        try:
            ...
            if any(
                header in str(row).lower()
                for header in ["timestamp", "sensor_id", "object_id"]
            ):
                return None
    ...
    def _create_normalized_detection(
        self, raw_data: MARARawData, original_line: str
        ...
        try:
            ...
            self.logger.error(
                "Failed to create normalized detection",
                error=str(e),
    ...
    def _parse_confidence(self, confidence_val: Any) -> float | None:
    ...
    def _parse_range(self, range_val: Any) -> float | None:
