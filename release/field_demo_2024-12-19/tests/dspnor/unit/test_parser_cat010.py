...
class TestCAT010Parser(unittest.TestCase):
    ...
    def test_parse_time_of_day(self):
        ...
        data = (
            b"\x0A"
            + struct.pack(">H", 3 + len(fspec) + len(tod_data))
            + fspec
            + tod_data
        )
        result = self.parser.parse(data)
    ...
    def test_parse_track_number(self):
        ...
        data = (
            b"\x0A"
            + struct.pack(">H", 3 + len(fspec) + len(track_num_data))
            + fspec
            + track_num_data
        )
        result = self.parser.parse(data)
    ...
    def test_parse_target_address(self):
        ...
        data = (
            b"\x0A"
            + struct.pack(">H", 3 + len(fspec) + len(addr_data))
            + fspec
            + addr_data
        )
        result = self.parser.parse(data)
    ...
    def test_parse_track_quality(self):
        ...
        data = (
            b"\x0A"
            + struct.pack(">H", 3 + len(fspec) + len(quality_data))
            + fspec
            + quality_data
        )
        result = self.parser.parse(data)
    ...
    def test_parse_ground_speed(self):
        ...
        data = (
            b"\x0A"
            + struct.pack(">H", 3 + len(fspec) + len(speed_data))
            + fspec
            + speed_data
        )
        result = self.parser.parse(data)
    ...
    def test_parse_track_angle_rate(self):
        ...
        data = (
            b"\x0A"
            + struct.pack(">H", 3 + len(fspec) + len(rate_data))
            + fspec
            + rate_data
        )
        result = self.parser.parse(data)
    ...
    def test_parse_mode_3a_code(self):
        ...
        data = (
            b"\x0A"
            + struct.pack(">H", 3 + len(fspec) + len(code_data))
            + fspec
            + code_data
        )
        result = self.parser.parse(data)
    ...
    def test_parse_target_identification(self):
        ...
        data = (
            b"\x0A" + struct.pack(">H", 3 + len(fspec) + len(id_data)) + fspec + id_data
        )
        result = self.parser.parse(data)
    ...
    def test_parse_multiple_items(self):
        ...
        data = (
            b"\x0A"
            + struct.pack(
                ">H", 3 + len(fspec) + len(tod_data) + len(track_data) + len(addr_data)
            )
            + fspec
            + tod_data
            + track_data
    ...
    def test_extract_velocity_ground_speed(self):
        ...
        track = type(
            "Track",
            (),
            {"velocity_polar": None, "velocity_cartesian": None, "ground_speed": 30.0},
        )()
    ...
    def test_get_track_id_from_number(self):
        ...
        track = type("Track", (), {"track_number": 12345, "target_address": None})()
    ...
    def test_get_track_id_from_address(self):
        ...
        track = type("Track", (), {"track_number": None, "target_address": 0x123456})()
    ...
    def test_get_track_id_fallback(self):
        ...
        track = type("Track", (), {"track_number": None, "target_address": None})()
