...
class TestKeyValueParsing:
    ...
    def test_kv_latitude_clamping(self):
        ...
        kv_line = 'timestamp=2025-01-16T10:30:45.123Z sensor_id=EO_001 lat=95.0 channel=EO'
        detection = self.parser.autodetect_and_parse(kv_line)
    ...
    def test_kv_longitude_clamping(self):
        ...
        kv_line = 'timestamp=2025-01-16T10:30:45.123Z sensor_id=EO_001 lon=185.0 channel=EO'
        detection = self.parser.autodetect_and_parse(kv_line)
