...
def normalize_env(env: Dict[str, str]) -> Dict[str, object]:
    ...
    int_keys = {
        "SEACROSS_PORT", "VISION_FRAME_SKIP", "VISION_N_CONSEC_FOR_TRUE",
        "VISION_LATENCY_MS", "VISION_MAX_DWELL_MS", "VISION_INPUT_RES",
    }
    float_keys = {
        "BOW_ZERO_DEG", "DRONESHIELD_BEARING_OFFSET_DEG", "TRAKKA_BEARING_OFFSET_DEG",
        "VISION_BEARING_OFFSET_DEG", "ACOUSTIC_BEARING_OFFSET_DEG",
        "VISION_ROI_HALF_DEG", "VISION_SWEEP_STEP_DEG",
        "CONFIDENCE_BASE", "CONFIDENCE_TRUE", "CONFIDENCE_FALSE", "CONF_HYSTERESIS",
        "WEIGHT_RF", "WEIGHT_VISION", "WEIGHT_IR", "WEIGHT_ACOUSTIC",
        "RANGE_FIXED_KM", "RANGE_RSSI_REF_DBM", "RANGE_RSSI_REF_KM",
        "RANGE_MIN_KM", "RANGE_MAX_KM", "RANGE_EWMA_ALPHA",
        "EO_FOV_WIDE_DEG", "EO_FOV_NARROW_DEG", "IR_FOV_WIDE_DEG", "IR_FOV_NARROW_DEG",
    }
    bool_keys = {
        "CAMERA_CONNECTED",
    }
