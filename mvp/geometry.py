...
def apply_offsets(raw_bearing_deg: float, plugin_offset_deg: float, bow_zero_deg: float) -> float:
    """
...
def compute_roi_sector(bearing_deg: float, fov_deg: float, roi_half_deg: float) -> Tuple[float, float]:
    """
