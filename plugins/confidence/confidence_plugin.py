...
class ConfidencePlugin:
    def __init__(self):
        ...
        self.vision_true_time: Dict[str, float] = {}  # track_id -> timestamp when vision confirmed
        self.updates = 0
    ...
    def update(self, prev_c01: float, cues: Dict, vision_event: Optional[Dict] = None) -> ConfidenceUpdate:
        """
    ...
    def _handle_vision_event(self, track_id: str, prev_c01: float, vision_event: Dict, now: float) -> ConfidenceUpdate:
    ...
    def _bayesian_update(self, track_id: str, prev_c01: float, cues: Dict, now: float) -> ConfidenceUpdate:
    ...
    def _weighted_update(self, track_id: str, prev_c01: float, cues: Dict, now: float) -> ConfidenceUpdate:
