...
def normalize_angle(angle: Union[float, str, None]) -> Optional[float]:
    """
...
def clamp_value(value: Union[float, str, None], 
...
def convert_range_to_km(range_m: Union[float, str, None]) -> Optional[float]:
    """
...
def parse_confidence(confidence: Union[float, str, None]) -> Optional[float]:
    """
...
def normalize_sensor_channel(channel: Union[str, None]) -> str:
    """
...
def safe_float(value: Union[float, str, None]) -> Optional[float]:
    """
...
def safe_int(value: Union[int, str, None]) -> Optional[int]:
    """
