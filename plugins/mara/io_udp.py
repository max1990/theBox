...
class MARAUDPProtocol(asyncio.DatagramProtocol):
    ...
    def __init__(self, message_handler: Optional[Callable[[str], None]], logger):
        self.message_handler = message_handler
        self.logger = logger
    ...
    def datagram_received(self, data: bytes, addr):
        ...
        try:
            ...
            self.logger.debug("Received UDP message", 
                            addr=addr, 
                            length=len(data),
            ...
            self.logger.error("Error processing UDP message", 
                            error=str(e), 
                            addr=addr,
