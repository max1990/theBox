...
class DspnorMetrics:
    ...
    def __init__(self):
        ...
        self.last_cat010_time: Optional[datetime] = None
        self.last_nmea_time: Optional[datetime] = None
    ...
    def set_connection_status(self, discovery: bool = None, info: bool = None,
                            cat010: bool = None, nmea: bool = None):
    ...
    def get_last_status_age_seconds(self) -> Optional[float]:
    ...
    def get_last_discovery_age_seconds(self) -> Optional[float]:
    ...
    def get_last_cat010_age_seconds(self) -> Optional[float]:
    ...
    def get_last_nmea_age_seconds(self) -> Optional[float]:
