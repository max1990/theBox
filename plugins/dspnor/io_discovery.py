...
from .constants import (
    ...
    DISCOVERY_BEACON_SIZE, D2D_PROTOCOL, D2D_VERSION, D2D_TYPE_TEXT
)
from .schemas import DiscoveryBeacon, UnitInfo, D2DHeader
...
class D2DProtocol:
    ...
    def build_header(json_data: str) -> str:
        ...
        return f"{D2D_PROTOCOL}={D2D_PROTOCOL}\n" \
...
class DiscoveryClient:
    ...
    def __init__(self, multicast_group: str = DEFAULT_DISCOVERY_MULTICAST, 
        ...
        self.callback: Optional[Callable[[UnitInfo], None]] = None
    ...
    def start(self):
        ...
        try:
            ...
            self.logger.info("Discovery client started", 
                           multicast_group=self.multicast_group, port=self.port)
    ...
    def _parse_beacon(self, data: bytes, ip: str) -> Optional[DiscoveryBeacon]:
    ...
    def get_discovered_units(self) -> Dict[str, UnitInfo]:
        ...
        now = datetime.now()
        stale_units = [
            serial for serial, unit in self.discovered_units.items()
...
class InfoClient:
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            self.logger.error("Failed to connect to info port", 
